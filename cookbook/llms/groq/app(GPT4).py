...
st.set_page_config(
    page_title="Sermon Facilitator Notes Generator",
    page_icon=":pray:",
)
st.title("Sermon Facilitator Notes Generator powered by Groq")
...
def main() -> None:
    ...
    if "youtube_url" in st.session_state:
        ...
        st.write("Please provide a sermon video URL or click on one of the trending sermons.")
